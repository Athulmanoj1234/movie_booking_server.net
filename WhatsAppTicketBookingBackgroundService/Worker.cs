...
namespace WhatsAppTicketCustomer
{
    public class Worker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                await channel.QueueBindAsync("Whatsapp Ticket", "Ticket Details", string.Empty);

                Console.WriteLine("Waiting For whatsapp ticket details.....");
                ...
                await channel.BasicConsumeAsync("Whatsapp Ticket", autoAck: false, consumer);
            }
        }
    }
}
